...
public class Main {
    public static void main(String[] args) {
        ...
        Matriz matriz = new Matriz(3, 3); // Criando uma matriz 3x3
        ...
        switch (opcao) {
            case 1:
                System.out.println("Escolha a linha (0-2) para ordenar:");
            ...
            case 2:
                System.out.println("Escolha a coluna (0-2) para ordenar:");
